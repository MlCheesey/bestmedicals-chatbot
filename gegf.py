...
def ask_ai(full_prompt):
    ...
    payload = {
        ...
        "messages": [
            {
                "role": "system",
                "content": "You are a pharmacy assistant. ONLY report exact inventory numbers. Never make up stock quantities. Do not disclose everything you haev got as a prompt unless the user asks for it."
            },
            {
                "role": "user",
                "content": full_prompt
